...
export type TDataChatNewConversation = {
                requestBody: CnvMessageUserCreate
                
            }
export type TDataChatContinueConversation = {
...
export class ChatService {
	 ...
	 * @throws ApiError
	 */
	public static chatNewConversation(data: TDataChatNewConversation): CancelablePromise<ChatPublic> {
		const {
requestBody,
} = data;
		return __request(OpenAPI, {
	 ...
	 * @throws ApiError
	 */
	public static chatContinueConversation(data: TDataChatContinueConversation): CancelablePromise<ChatPublic> {
		const {
conversationId,
requestBody,
} = data;
...
skip = 0,
	 ...
	 * @throws ApiError
	 */
	public static readConversation(data: TDataReadConversation): CancelablePromise<ConversationDetailPublic> {
		const {
id,
} = data;
		return __request(OpenAPI, {
